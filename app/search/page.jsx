...
import { Search, ArrowRight, User, Stethoscope, FileText, ChevronRight, Loader2 } from "lucide-react";
                    ...
                    <div className="max-w-6xl mx-auto space-y-16">
                        ...
                        <div className="flex items-center justify-between border-b-2 border-primary/10 pb-6">
                            ...
                            <div className="flex gap-4">
                                {["Doctors", "Services", "Blog"].map(tab => (
                                    <div key={tab} className="px-6 py-2.5 bg-white rounded-full text-[10px] font-black text-gray-muted uppercase tracking-widest border border-gray-lighter">
                                        {tab}
                                    </div>
                                ))}
                            </div>
